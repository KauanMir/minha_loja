...
class AddProduto(db.Model):
    ...
    image_1 = db.Column(db.String, nullable=False, default='image.jpg')
    image_2 = db.Column(db.String, nullable=False, default='image.jpg')
    image_3 = db.Column(db.String, nullable=False, default='image.jpg')
